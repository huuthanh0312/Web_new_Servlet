...
@WebServlet("/MemberNewsADController")
public class MemberNewsADController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
  
    public MemberNewsADController() {
        super();
		...
		try {
		  ...
		  if(kt) { 
			 try {
				 ...
				 RequestDispatcher rd = request.getRequestDispatcher("MemberNewsADController?pageid=1");
