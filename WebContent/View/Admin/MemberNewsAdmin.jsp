                              ...
                              <div class="table-responsive  m-b-30 p-l-15 p-r-15">
                                 <table class="table table-borderless table-striped table-earning">
                                     <thead>
                                      ...
                                      <tbody>
                                        <c:forEach items="${listNewsMember}" var="listnews">
                                          <tr>
                                ...
                                <nav aria-label="Page navigation ">
                                    <ul class="pagination justify-content-start">        
                                       <c:if test="${numberpage == 1}">
                                        ...
                                        <li class="page-item" ><a  class="page-link" style="background: #e5e5e5;" href = "MemberNewsADForward?pageid=${numberpage}">${numberpage}</a></li>
			                            <li class="page-item"><a  class="page-link" href = "MemberNewsADForward?pageid=${numberpage+1}">${numberpage+1}</a></li>
			                            <li class="page-item"><a   class="page-link"href = "MemberNewsADForward?pageid=${numberpage+1}">Next</a></li>
		                               </c:if>
		                               <c:if test="${numberpage == maxpageid}">
			                            <li class="page-item"><a  class="page-link" href = "MemberNewsADForward?pageid=${numberpage-1}">Prev</a></li>
			                            <li class="page-item"><a  class="page-link" href = "MemberNewsADForward?pageid=${numberpage-1}">${numberpage-1}</a></li>
			                            <li class="page-item"><a  class="page-link" style="background: #e5e5e5;" href = "MemberNewsADForward?pageid=${numberpage}">${numberpage}</a></li>
                        ...
                        <div class="card">
                          <div class="card-header">
                              ...
                              <div class="card-body card-block">
                                 <form action="MemberNewsADController" method="POST" name="myform" onsubmit="return Validate()" > 
